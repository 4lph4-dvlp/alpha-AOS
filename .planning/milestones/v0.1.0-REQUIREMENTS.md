# Requirements Archive: v0.1.0 Vertical MVP
...
- [x] **CAPA-02**: User can request multi-source research without naming a skill or MCP and have native deep-research routing use Exa for source discovery and Firecrawl only for bounded extraction, while ordinary lookups do not fan out across every research tool
- [x] **CAPA-03**: User can perform an explicit cross-harness handoff through Unified Memory without Memory Vault content modifying `.planning/` or becoming authoritative project policy
...
- [x] **LIFE-08**: User can run update preview with no checkout, package, global-link, configuration, or managed-state mutation, and update apply reconciles only a reviewed stable-lock promotion
...
- [x] **PACK-01**: User receives a built-in cross-harness skill (`alpha-aos-pack-advisor`) deployed to all supported harnesses that detects newly available project capability packs, prompts for user approval, and executes plan approval and materialization without manual hash copying
- [x] **PACK-02**: The pack advisor preserves determinism, strict plan digest verification, rollback safety, and fails closed on receipt or digest tampering
- [x] **PACK-03**: The advisor skill is registered in `catalog/stack.yaml` as an owned skill and distributed to Claude, Codex, Antigravity, Pi, and Hermes via managed install and update
...
| CAPA-02 | Phase 3 | Complete |
| CAPA-03 | Phase 3 | Complete |
...
| OPTO-03 | Phase 5 | Complete |
| OPTO-04 | Phase 5 | Complete |
| OPTO-05 | Phase 5 | Complete |
| OPTO-06 | Phase 5 | Complete |
| OPTO-07 | Phase 5 | Complete |
| OPTO-08 | Phase 5 | Complete |
| OPTO-09 | Phase 5 | Complete |
| LIFE-01 | Phase 6 | Partial (G-11-1) — [06-VERIFICATION.md](v0.1.0-phases/06-managed-lifecycle-uninstall-and-recovery/06-VERIFICATION.md) |
| LIFE-02 | Phase 6 | Partial (G-11-2, G-11-3, G-11-4, G-11-5, G-11-6, G-11-7) — [06-VERIFICATION.md](v0.1.0-phases/06-managed-lifecycle-uninstall-and-recovery/06-VERIFICATION.md) |
| LIFE-03 | Phase 6 | Gap (G-11-8, G-11-9, G-11-10, G-11-11, G-11-12) — [06-VERIFICATION.md](v0.1.0-phases/06-managed-lifecycle-uninstall-and-recovery/06-VERIFICATION.md) |
| LIFE-04 | Phase 6 | Gap (G-11-13, G-11-14, G-11-15, G-11-16, G-11-17) — [06-VERIFICATION.md](v0.1.0-phases/06-managed-lifecycle-uninstall-and-recovery/06-VERIFICATION.md) |
| LIFE-05 | Phase 6 | Partial (G-11-18) — [06-VERIFICATION.md](v0.1.0-phases/06-managed-lifecycle-uninstall-and-recovery/06-VERIFICATION.md) |
| LIFE-06 | Phase 6 | Partial (G-11-19, G-11-20, G-11-21, G-11-22) — [06-VERIFICATION.md](v0.1.0-phases/06-managed-lifecycle-uninstall-and-recovery/06-VERIFICATION.md) |
| LIFE-07 | Phase 6 | Gap (G-11-23, G-11-24, G-11-25, G-11-26) — [06-VERIFICATION.md](v0.1.0-phases/06-managed-lifecycle-uninstall-and-recovery/06-VERIFICATION.md) |
| LIFE-08 | Phase 6 | Verified — [06-VERIFICATION.md](v0.1.0-phases/06-managed-lifecycle-uninstall-and-recovery/06-VERIFICATION.md) |
| REL-01 | Phase 7 | Complete |
| REL-02 | Phase 7 | Gaps Found (G-07-2) |
