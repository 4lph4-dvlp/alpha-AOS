...
**Plans**: 24/26 plans executed (23 executed; 3 gap-closure plans pending for verification gap G-01-1, root cause RC-5)
...
|-------|----------------|--------|-----------|
| 1. Safe Operation Boundary | 24/26 | In Progress|  |
